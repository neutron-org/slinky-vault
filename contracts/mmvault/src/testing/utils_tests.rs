...
#[test_case(1000000, 2000000, 0, 0, "1", "1", "1", 5, false, 50u32 => DepositResult { amount0: Uint128::new(50000), amount1: Uint128::new(575000), tick_index: 0, fee: 0 }; "imbalance case")]
#[test_case(1000000, 2000000, 0, 0, "1", "1", "1", 0, false, 50u32 => DepositResult { amount0: Uint128::new(0), amount1: Uint128::new(500000), tick_index: 0, fee: 0 }; "0% base deposit")]
#[test_case(1000000, 1000000,  0, 0, "1", "1", "1", 50, false, 50u32 => DepositResult { amount0: Uint128::new(500000), amount1: Uint128::new(500000), tick_index: 0, fee: 0 }; "balanced case")]
#[test_case(1000000, 1000000, 0, 0, "2", "1", "2", 50, false, 50u32  => DepositResult { amount0: Uint128::new(625000), amount1: Uint128::new(500000), tick_index: 0, fee: 0 }; "unequal token prices")]
#[test_case(1000000, 1000000, 0, 0, "1", "2", "0.5", 50, false, 50u32 => DepositResult { amount0: Uint128::new(500000), amount1: Uint128::new(625000), tick_index: 0, fee: 0 }; "inverse unequal token prices")]
#[test_case(1000000, 1000000,  0, 0, "1", "1", "1", 100, false, 50u32 => DepositResult { amount0: Uint128::new(1000000), amount1: Uint128::new(1000000), tick_index: 0, fee: 0 }; "100% deposit")]
#[test_case(0, 1000000, 0, 0, "1", "1", "1", 5, false, 50u32 => DepositResult { amount0: Uint128::new(0), amount1: Uint128::new(525000), tick_index: 0, fee: 0 }; "one token unavailable")]
#[test_case(0, 0, 0, 0, "1", "1", "1", 5, false, 50u32 => DepositResult { amount0: Uint128::new(0), amount1: Uint128::new(0), tick_index: 0, fee: 0 }; "both tokens unavailable")]
// value 0 = 1000000
// value 1 = 1100000
// imbalance = 1100000 - 1000000 / 2 = 50000
// additional token 1 = 50000 / 1.1 = 45454.54 -> 45454
#[test_case(1000000, 1000000, 0, 0, "1", "1.1", "1", 0, false, 50u32 => DepositResult { amount0: Uint128::new(0), amount1: Uint128::new(45454), tick_index: 0, fee: 0 }; "slight price difference")]
...
#[test_case(1000000, 1000000, 0, 0, "1", "1.1", "1", 5, false, 50u32 => DepositResult { amount0: Uint128::new(50000), amount1: Uint128::new(93181), tick_index: 0, fee: 0 }; "slight price difference with 5% deposit")]
#[test_case(1000000, 1000000, 0, 0, "1", "1", "1", 100, false, 50u32 => DepositResult { amount0: Uint128::new(1000000), amount1: Uint128::new(1000000), tick_index: 0, fee: 0 }; "capped deposit amounts")]
...
#[test_case(1000000, 1000000, 0, 0, "1", "200", "1", 10, false, 50u32 => DepositResult { amount0: Uint128::new(100000), amount1: Uint128::new(547750), tick_index: 0, fee: 0 }; "large price difference")]
#[test_case(0, 1000000, 0, 10, "1", "1", "1", 10, true, 50u32 => DepositResult { amount0: Uint128::new(0), amount1: Uint128::new(550000), tick_index: -9, fee: 10 }; "large price difference with skew token0")]
#[test_case(1000000, 0, 0, 10, "1", "1", "1", 10, true, 50u32 => DepositResult { amount0: Uint128::new(550000), amount1: Uint128::new(0), tick_index: 9, fee: 10 }; "large price difference with skew token1")]
#[test_case(10000000, 0, 0, 100, "1", "1", "1", 10, true, 50u32 => DepositResult { amount0: Uint128::new(5500000), amount1: Uint128::new(0), tick_index: 99, fee: 100 }; "test skew sequence -1")]
#[test_case(9000000, 1000000, 0, 100, "1", "1", "1", 10, true, 50u32=> DepositResult { amount0: Uint128::new(4500000), amount1: Uint128::new(100000), tick_index: 79, fee: 100 }; "test skew sequence -2")]
#[test_case(8000000, 2000000, 0, 100, "1", "1", "1", 10, true, 50u32 => DepositResult { amount0: Uint128::new(3500000), amount1: Uint128::new(200000), tick_index: 59, fee: 100 }; "test skew sequence -3")]
#[test_case(7000000, 3000000, 0, 100, "1", "1", "1", 10, true, 50u32 => DepositResult { amount0: Uint128::new(2500000), amount1: Uint128::new(300000), tick_index: 40, fee: 100 }; "test skew sequence -4")] 
#[test_case(6000000, 4000000, 0, 100, "1", "1", "1", 10, true, 50u32 => DepositResult { amount0: Uint128::new(1500000), amount1: Uint128::new(400000), tick_index: 20, fee: 100 }; "test skew sequence -5")]

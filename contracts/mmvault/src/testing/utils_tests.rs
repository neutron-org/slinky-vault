...
#[test_case(1000000, 1000000,  0, 0, "1", "1", "1", 50, 0i32, 50u32, 0i32 => DepositResult { amount0: Uint128::new(500000), amount1: Uint128::new(500000), tick_index: 0, fee: 0 }; "balanced case")]
#[test_case(1000000, 1000000, 0, 0, "2", "1", "2", 50, 0i32, 50u32, 0i32 => DepositResult { amount0: Uint128::new(750000), amount1: Uint128::new(500000), tick_index: 0, fee: 0 }; "unequal token prices")]
#[test_case(1000000, 1000000, 0, 0, "1", "2", "0.5", 50, 0i32, 50u32, 0i32 => DepositResult { amount0: Uint128::new(500000), amount1: Uint128::new(750000), tick_index: 0, fee: 0 }; "inverse unequal token prices")]
#[test_case(1000000, 1000000,  0, 0, "1", "1", "1", 100, 0i32, 50u32, 0i32 => DepositResult { amount0: Uint128::new(1000000), amount1: Uint128::new(1000000), tick_index: 0, fee: 0 }; "100% deposit")]
#[test_case(0, 1000000, 0, 0, "1", "1", "1", 5, 0i32, 50u32, 0i32 => DepositResult { amount0: Uint128::new(0), amount1: Uint128::new(550000), tick_index: 0, fee: 0 }; "one token unavailable")]
#[test_case(0, 0, 0, 0, "1", "1", "1", 5, 0i32, 50u32, 0i32 => DepositResult { amount0: Uint128::new(0), amount1: Uint128::new(0), tick_index: 0, fee: 0 }; "both tokens unavailable")]
// value 0 = 1000000
// value 1 = 1100000
// imbalance = 1100000 - 1000000 / 2 = 50000
// additional token 1 = 50000 / 1.1 = 45454.54 -> 45454
#[test_case(1000000, 1000000, 0, 0, "1", "1.1", "1", 0, 0i32, 50u32, 0i32  => DepositResult { amount0: Uint128::new(0), amount1: Uint128::new(45454), tick_index: 0, fee: 0 }; "slight price difference")]
...
#[test_case(1000000, 1000000, 0, 0, "1", "1.1", "1", 5, 0i32, 50u32, 0i32 => DepositResult { amount0: Uint128::new(50000), amount1: Uint128::new(95454), tick_index: 0, fee: 0 }; "slight price difference with 5% deposit")]
#[test_case(1000000, 1000000, 0, 0, "1", "1", "1", 100, 0i32, 50u32, 0i32 => DepositResult { amount0: Uint128::new(1000000), amount1: Uint128::new(1000000), tick_index: 0, fee: 0 }; "capped deposit amounts")]
...
#[test_case(1000000, 1000000, 0, 0, "1", "200", "1", 10, 0i32, 50u32, 0i32 => DepositResult { amount0: Uint128::new(100000), amount1: Uint128::new(597500), tick_index: 0, fee: 0 }; "large price difference")]
#[test_case(0, 1000000, 0, 10, "1", "1", "1", 10, 9, 50u32, 0i32 => DepositResult { amount0: Uint128::new(0), amount1: Uint128::new(600000), tick_index: -9, fee: 10 }; "large price difference with skew token0")]
#[test_case(1000000, 0, 0, 10, "1", "1", "1", 10, 9, 50u32, 0i32 => DepositResult { amount0: Uint128::new(600000), amount1: Uint128::new(0), tick_index: 9, fee: 10 }; "large price difference with skew token1")]
#[test_case(10000000, 0, 0, 100, "1", "1", "1", 10, 99, 50u32, 0i32 => DepositResult { amount0: Uint128::new(6000000), amount1: Uint128::new(0), tick_index: 99, fee: 100 }; "test skew sequence -1")]
#[test_case(9000000, 1000000, 0, 100, "1", "1", "1", 10, 99, 50u32, 0i32 => DepositResult { amount0: Uint128::new(4900000), amount1: Uint128::new(100000), tick_index: 79, fee: 100 }; "test skew sequence -2")]
#[test_case(8000000, 2000000, 0, 100, "1", "1", "1", 10, 99, 50u32, 0i32 => DepositResult { amount0: Uint128::new(3800000), amount1: Uint128::new(200000), tick_index: 59, fee: 100 }; "test skew sequence -3")]
#[test_case(7000000, 3000000, 0, 100, "1", "1", "1", 10, 99, 50u32, 0i32 => DepositResult { amount0: Uint128::new(2700000), amount1: Uint128::new(300000), tick_index: 40, fee: 100 }; "test skew sequence -4")]
#[test_case(6000000, 4000000, 0, 100, "1", "1", "1", 10, 99, 50u32, 0i32 => DepositResult { amount0: Uint128::new(1600000), amount1: Uint128::new(400000), tick_index: 20, fee: 100 }; "test skew sequence -5")]
#[test_case(5000000, 5000000, 0, 100, "1", "1", "1", 10, 99, 50u32, 0i32 => DepositResult { amount0: Uint128::new(500000), amount1: Uint128::new(500000), tick_index: 0, fee: 100 }; "test skew sequence -6")]
#[test_case(10000000, 0, 0, 100, "1", "1", "1", 10, 99, 50u32, 0i32 => DepositResult { amount0: Uint128::new(6000000), amount1: Uint128::new(0), tick_index: 99, fee: 100 }; "test double skew sequence -1")]
#[test_case(1000000, 1000000, 0, 0, "1", "200", "1", 10, 0i32, 50u32, 1i32 => DepositResult { amount0: Uint128::new(100000), amount1: Uint128::new(597500), tick_index: 1, fee: 0 }; "test oracle skew -1")]
#[test_case(1000000, 1000000, 0, 0, "1", "200", "1", 10, 0i32, 50u32, 11i32 => DepositResult { amount0: Uint128::new(100000), amount1: Uint128::new(597500), tick_index: 11, fee: 0 }; "test oracle skew -2")]
#[test_case(1000000, 1000000, 0, 0, "1", "200", "1", 10, 0i32, 50u32, 111i32 => DepositResult { amount0: Uint128::new(100000), amount1: Uint128::new(597500), tick_index: 111, fee: 0 }; "test oracle skew -3")]
#[test_case(1000000, 1000000, 0, 0, "1", "200", "1", 10, 0i32, 50u32, 99999i32 => DepositResult { amount0: Uint128::new(100000), amount1: Uint128::new(597500), tick_index: 99999, fee: 0 }; "test oracle skew -4")]
#[test_case(1000000, 1000000, 0, 0, "1", "200", "1", 10, 0i32, 50u32, -1i32 => DepositResult { amount0: Uint128::new(100000), amount1: Uint128::new(597500), tick_index: -1, fee: 0 }; "test oracle skew -5")]
#[test_case(1000000, 1000000, 0, 0, "1", "200", "1", 10, 0i32, 50u32, -11i32 => DepositResult { amount0: Uint128::new(100000), amount1: Uint128::new(597500), tick_index: -11, fee: 0 }; "test oracle skew -6")]
#[test_case(1000000, 1000000, 0, 0, "1", "200", "1", 10, 0i32, 50u32, -111i32 => DepositResult { amount0: Uint128::new(100000), amount1: Uint128::new(597500), tick_index: -111, fee: 0 }; "test oracle skew -7")]
#[test_case(1000000, 1000000, 0, 0, "1", "200", "1", 10, 0i32, 50u32, -99999i32 => DepositResult { amount0: Uint128::new(100000), amount1: Uint128::new(597500), tick_index: -99999, fee: 0 }; "test oracle skew -8")]
#[test_case(9000000, 1000000, 0, 100, "1", "1", "1", 10, 99, 50u32, 1i32 => DepositResult { amount0: Uint128::new(4900000), amount1: Uint128::new(100000), tick_index: 80, fee: 100 }; "test double skew sequence -2")]
#[test_case(8000000, 2000000, 0, 100, "1", "1", "1", 10, 99, 50u32, -2i32 => DepositResult { amount0: Uint128::new(3800000), amount1: Uint128::new(200000), tick_index: 57, fee: 100 }; "test double skew sequence -3")]
#[test_case(7000000, 3000000, 0, 100, "1", "1", "1", 10, 99, 50u32, 4i32 => DepositResult { amount0: Uint128::new(2700000), amount1: Uint128::new(300000), tick_index: 44, fee: 100 }; "test double skew sequence -4")]
#[test_case(6000000, 4000000, 0, 100, "1", "1", "1", 10, 99, 50u32, -8i32 => DepositResult { amount0: Uint128::new(1600000), amount1: Uint128::new(400000), tick_index: 12, fee: 100 }; "test double skew sequence -5")]

...
#[test_case(0, 3000000, 0, 0, "1", "1", "1", 10, 10i32, 50u32, 0i32, 0i32, 100i32 => DepositResult { amount0: Uint128::new(0), amount1: Uint128::new(1800000), tick_index: 40, fees: vec![FeeTier { fee: 50, percentage: 100 }] }; "omni-skew-sequence-3-double-skew-b-dominant")]
#[test_case(3000000, 0, 0, 0, "1", "1", "1", 10, 10i32, 50u32, 0i32, 0i32, 100i32 => DepositResult { amount0: Uint128::new(1800000), amount1: Uint128::new(0), tick_index: -40, fees: vec![FeeTier { fee: 50, percentage: 100 }] }; "omni-skew-sequence-4-double-skew-a-dominant")]
#[test_case(1, 299999, 0, 0, "1", "1", "1", 10, 10i32, 50u32, 0i32, 0i32, 100i32 => DepositResult { amount0: Uint128::new(0), amount1: Uint128::new(179998), tick_index: 40, fees: vec![FeeTier { fee: 50, percentage: 100 }] }; "omni-skew-sequence-edge-case-1")]
...
#[test_case(299999, 1, 0, 0, "1", "1", "1", 10, 10i32, 50u32, 0i32, 0i32, 100i32 => DepositResult { amount0: Uint128::new(179998), amount1: Uint128::new(0), tick_index: -40, fees: vec![FeeTier { fee: 50, percentage: 100 }] }; "omni-skew-sequence-edge-case-2")]
#[test_case(1, 299999, 0, 0, "1", "1", "1", 10, 10i32, 50u32, 0i32, -1000i32, 300i32 => DepositResult { amount0: Uint128::new(0), amount1: Uint128::new(179998), tick_index: 140, fees: vec![FeeTier { fee: 150, percentage: 100 }] }; "omni-skew-sequence-edge-case-3")]
#[test_case(299999, 1, 0, 0, "1", "1", "1", 10, 10i32, 50u32, 0i32, 1000i32, 300i32 => DepositResult { amount0: Uint128::new(179998), amount1: Uint128::new(0), tick_index: -140, fees: vec![FeeTier { fee: 150, percentage: 100 }] }; "omni-skew-sequence-edge-case-4")]

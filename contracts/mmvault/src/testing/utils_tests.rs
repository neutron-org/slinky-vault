...
#[test_case(1000000, 2000000, 0, 0, "1", "1", "1", 5, false, 50u32 => DepositResult { amount0: Uint128::new(50000), amount1: Uint128::new(600000), tick_index: 0, fee: 0 }; "imbalance case")]
...
#[test_case(1000000, 1000000, 0, 0, "2", "1", "2", 50, false, 50u32  => DepositResult { amount0: Uint128::new(750000), amount1: Uint128::new(500000), tick_index: 0, fee: 0 }; "unequal token prices")]
#[test_case(1000000, 1000000, 0, 0, "1", "2", "0.5", 50, false, 50u32 => DepositResult { amount0: Uint128::new(500000), amount1: Uint128::new(750000), tick_index: 0, fee: 0 }; "inverse unequal token prices")]
...
#[test_case(0, 1000000, 0, 0, "1", "1", "1", 5, false, 50u32 => DepositResult { amount0: Uint128::new(0), amount1: Uint128::new(550000), tick_index: 0, fee: 0 }; "one token unavailable")]
...
#[test_case(1000000, 1000000, 0, 0, "1", "1.1", "1", 5, false, 50u32 => DepositResult { amount0: Uint128::new(50000), amount1: Uint128::new(95454), tick_index: 0, fee: 0 }; "slight price difference with 5% deposit")]
...
#[test_case(1000000, 1000000, 0, 0, "1", "200", "1", 10, false, 50u32 => DepositResult { amount0: Uint128::new(100000), amount1: Uint128::new(597500), tick_index: 0, fee: 0 }; "large price difference")]
#[test_case(0, 1000000, 0, 10, "1", "1", "1", 10, true, 50u32 => DepositResult { amount0: Uint128::new(0), amount1: Uint128::new(600000), tick_index: -9, fee: 10 }; "large price difference with skew token0")]
#[test_case(1000000, 0, 0, 10, "1", "1", "1", 10, true, 50u32 => DepositResult { amount0: Uint128::new(600000), amount1: Uint128::new(0), tick_index: 9, fee: 10 }; "large price difference with skew token1")]

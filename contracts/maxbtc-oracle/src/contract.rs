...
pub fn instantiate(
    ...
    let maxbtc_core_contract = deps.api.addr_validate(&msg.maxbtc_core_contract)?;
    ...
    let config = &Config {
        owners,
        maxbtc_core_contract: maxbtc_core_contract.clone(),
    ...
    Ok(Response::new()
        ...
        .add_attributes([
            attr("maxbtc_core_contract", format!("{:?}", config.maxbtc_core_contract)),
...
pub fn query(deps: Deps, _env: Env, msg: QueryMsg) -> ContractResult<Binary> {
    match msg {
        ...
        QueryMsg::GetMaxBtcRedemptionRate {} => {
            let maxbtc_redemption_rate = query_maxbtc_exchange_rate(deps, _env)?;
            let serialized_rate =
...
fn execute_update_config(
    ...
    if let Some(maxbtc_core_contract) = new_config.maxbtc_core_contract {
        let new_maxbtc_core_contract = deps.api.addr_validate(&maxbtc_core_contract)?;
        config.maxbtc_core_contract = new_maxbtc_core_contract;
    }
